...
1. [`description.md`](/workspaces/cfg-pi-wizzy/local/acmed/description.md)
...
- The ACME adapter must follow the explicit contract in [`acme-api-reference.md`](/workspaces/cfg-pi-wizzy/local/acmed/acme-api-reference.md).
