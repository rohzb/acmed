...
> [!TIP]
> **TL;DR**
> This document defines the broker order lifecycle, core runtime records, persistence shape, and storage model.
...
For the broker-native HTTP contract, use [`broker-api-reference.md`](./broker-api-reference.md).
