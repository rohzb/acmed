...
For strict machine-oriented implementation constraints, see [`../models/implementation-constraints.md`](../models/implementation-constraints.md).
...
For per-file responsibilities and implementation-oriented rules, use [`implementation-guide.md`](../guides/implementation-guide.md).
...
- expose ACME routes, admin inspection endpoints, and health endpoints from one service process for the v1
...
- [`overview.md`](../guides/overview.md): project purpose and success criteria
- [`configuration.md`](../reference/configuration.md): configuration, issuer profiles, and policy matching
- [`data-model.md`](./data-model.md): lifecycle, persistence, and storage
- [`implementation-guide.md`](../guides/implementation-guide.md): code-shape guidance and test expectations
- [`acme-api.md`](../reference/acme-api.md): primary ACME-facing behavior
- [`broker-api.md`](../reference/broker-api.md): later secondary broker-native HTTP behavior
- [`security-operations.md`](../guides/security-operations.md): security defaults and runtime posture
- [`implementation-roadmap.md`](../guides/implementation-roadmap.md): sequencing, iteration scope, and v1 completion
